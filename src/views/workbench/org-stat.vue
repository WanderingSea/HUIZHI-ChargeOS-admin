<template>
  <div class="statistics-page">
    ...
    <div class="breadcrumb">
      ...
      ><span class="sep">></span><span>机构统计</span><span class="sep">></span
      ><span class="bc-active">机构统计列表</span>
    </div>
    ...
    <div class="filter-card">
      <div class="filter-row">
        ...
        <div class="filter-item">
          <label class="filter-label">机构名称</label>
          <el-input
            v-model="filter.name"
            placeholder="请输入机构名称"
            size="default"
    ...
    <div class="table-card">
      <div class="table-header">
        <div class="table-title-wrap">
          <span class="table-title">机构维度统计表</span>
      ...
      >
        ...
        <el-table-column
          ...
          fixed="left"
        />
        <el-table-column label="上级机构" prop="parent" min-width="160" />
        <el-table-column
          label="注册用户数"
          prop="userCount"
          min-width="110"
  ...
  methods: {
    ...
    doExportTable() {
      const columns = [
        ...
        { label: "上级机构", prop: "parent" },
        { label: "注册用户数", prop: "userCount" },
        { label: "活跃用户数", prop: "activeUser" },
        { label: "电量(度)", prop: "power" },
        { label: "充电次数(次)", prop: "chargeCount" },
        { label: "订单总金额(元)", prop: "totalAmount" },
        { label: "机构优惠(元)", prop: "orgDiscount" },
      ];
      exportToCSV(columns, this.tableData, "机构统计", {
        pageName: "机构维度统计",
      });
    },
    handleExport() {
