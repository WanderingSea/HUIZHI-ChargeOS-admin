<template>
  <div class="statistics-page">
    ...
    <div class="breadcrumb">
      ...
      ><span class="sep">></span><span>时期统计</span><span class="sep">></span
      ...
      <div class="filter-row">
        ...
        <div class="filter-item">
          ...
          <el-select
            ...
            clearable
          >
            <el-option label="南京机构" value="nj" /><el-option
              label="苏州机构"
              value="sz"
            /><el-option label="上海机构" value="sh" />
          </el-select>
        </div>
    ...
    <div class="table-card">
      <div class="table-header">
        <div class="table-title-wrap">
          <span class="table-title">机构时期维度统计表</span>
      ...
      >
        <el-table-column
          ...
          fixed="left"
        />
        <el-table-column label="机构名称" prop="orgName" min-width="160" />
        <el-table-column
          label="用户数"
          prop="userCount"
          min-width="100"
