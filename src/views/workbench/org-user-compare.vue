<template>
  <div class="statistics-page">
    ...
    <div class="breadcrumb">
      ...
      ><span class="sep">></span><span>用户对比</span><span class="sep">></span
      ><span class="bc-active">用户对比列表</span>
    </div>
    ...
    <div class="filter-card">
      <div class="filter-row">
        ...
        <div class="filter-item">
          <label class="filter-label">对比用户</label>
          <el-select
            ...
            multiple-limit="5"
          >
            <el-option label="U001-张先生" value="1" /><el-option
              label="U002-李女士"
              value="2"
            /><el-option label="U003-王先生" value="3" /><el-option
              label="U004-赵女士"
              value="4"
            />
          </el-select>
    ...
    <div class="table-card">
      <div class="table-header">
        <div class="table-title-wrap">
          <span class="table-title">用户对比分析表</span>
...
export default {
  ...
  data() {
    return {
      ...
      filter: { users: ["1", "2", "3"] },
      userCols: [
        { key: "u1", name: "U001-张先生" },
        { key: "u2", name: "U002-李女士" },
        { key: "u3", name: "U003-王先生" },
      ],
      tableData: [
        { metric: "充电次数(次)", u1: "28", u2: "15", u3: "22", diff: "13" },
        {
          metric: "总充电量(度)",
          u1: "358.50",
          u2: "186.20",
        ...
        { metric: "注册天数", u1: "158", u2: "92", u3: "136", diff: "66" },
      ],
    };
  },
  methods: {
    ...
    handleReset() {
      ...
      this.filter = { users: ["1", "2", "3"] };
    },
    doExportTable() {
      const dynamicCols = this.userCols.map((uc) => ({
        label: uc.name,
        prop: uc.key,
      }));
      const columns = [
      ...
      exportToCSV(columns, this.tableData, "机构用户对比", {
        pageName: "机构用户维度对比",
      });
    },
    handleExport() {
